...
dataset_path = "/home/leo/ZK-CIL-NIDS/dataset_10"
            ...
            for test_dataset in self.day_datasets:
                with self.subTest(dataset=test_dataset):
                    try:
                        ...
                        #numeric_labels = np.where(y_train == "BENIGN", 0, 1)
                        ...
                        weights = rf_model.predict_proba(X_test)
                        ...
                        try:
                            ...
                            pass
                        del rf_model, X_test, y_test, Metadata, weights
